<?php
namespace Noerdisch\TestingFramework\Core\Unit;
...
abstract class UnitTestCase extends BaseTestCase
{
    ...
    protected function tearDown()
    {
        ...
        foreach ($reflection->getProperties() as $property) {
            ...
            if (
                !$property->isStatic()
                && $declaringClass !== \Noerdisch\TestingFramework\Core\Unit\UnitTestCase::class
                && $declaringClass !== \Noerdisch\TestingFramework\Core\BaseTestCase::class
